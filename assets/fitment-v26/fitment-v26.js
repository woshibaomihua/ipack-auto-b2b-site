...
const vehicles = [
  {id:'toyota-corolla', year:2021, make:'Toyota', model:'Corolla', body:'Sedan', img:'assets/images/vehicle-fallbacks/toyota-corolla.jpg', lampProfile:'sedan'},
  {id:'honda-civic', year:2022, make:'Honda', model:'Civic', body:'Sedan', img:'assets/images/vehicle-fallbacks/honda-civic.jpg', lampProfile:'sedan'},
  {id:'ford-f150', year:2022, make:'Ford', model:'F-150', body:'Pickup', img:'assets/images/vehicle-fallbacks/ford-f150.jpg', lampProfile:'pickup'},
  {id:'nissan-altima', year:2021, make:'Nissan', model:'Altima', body:'Sedan', img:'assets/images/vehicle-fallbacks/nissan-altima.jpg', lampProfile:'sedan'},
  {id:'hyundai-elantra', year:2022, make:'Hyundai', model:'Elantra', body:'Sedan', img:'assets/images/vehicle-fallbacks/hyundai-elantra.jpg', lampProfile:'sedan'},
  {id:'volkswagen-jetta', year:2021, make:'Volkswagen', model:'Jetta', body:'Sedan', img:'assets/images/vehicle-fallbacks/volkswagen-jetta.jpg', lampProfile:'sedan'},
  {id:'toyota-hilux', year:2022, make:'Toyota', model:'Hilux', body:'Pickup', img:'assets/images/vehicle-fallbacks/toyota-hilux.jpg', lampProfile:'pickup'},
  {id:'toyota-camry', year:2022, make:'Toyota', model:'Camry', body:'Sedan', img:'assets/images/vehicle-fallbacks/toyota-camry.jpg', lampProfile:'sedan'},
  {id:'toyota-rav4', year:2022, make:'Toyota', model:'RAV4', body:'SUV', img:'assets/images/vehicle-fallbacks/toyota-rav4.jpg', lampProfile:'suv'},
  {id:'honda-crv', year:2022, make:'Honda', model:'CR-V', body:'SUV', img:'assets/images/vehicle-fallbacks/honda-crv.jpg', lampProfile:'suv'},
  {id:'nissan-rogue', year:2022, make:'Nissan', model:'Rogue', body:'SUV', img:'assets/images/vehicle-fallbacks/nissan-rogue.jpg', lampProfile:'suv'},
  {id:'hyundai-tucson', year:2022, make:'Hyundai', model:'Tucson', body:'SUV', img:'assets/images/vehicle-fallbacks/hyundai-tucson.jpg', lampProfile:'suv'},
  {id:'volkswagen-tiguan', year:2021, make:'Volkswagen', model:'Tiguan', body:'SUV', img:'assets/images/vehicle-fallbacks/volkswagen-tiguan.jpg', lampProfile:'suv'},
  {id:'toyota-tacoma', year:2022, make:'Toyota', model:'Tacoma', body:'Pickup', img:'assets/images/vehicle-fallbacks/toyota-tacoma.jpg', lampProfile:'pickup'},
  {id:'ford-ranger', year:2022, make:'Ford', model:'Ranger', body:'Pickup', img:'assets/images/vehicle-fallbacks/ford-ranger.jpg', lampProfile:'pickup'},
  {id:'chevrolet-silverado', year:2021, make:'Chevrolet', model:'Silverado', body:'Pickup', img:'assets/images/vehicle-fallbacks/chevrolet-silverado.jpg', lampProfile:'pickup'},
  {id:'mazda-cx5', year:2022, make:'Mazda', model:'CX-5', body:'SUV', img:'assets/images/vehicle-fallbacks/mazda-cx5.jpg', lampProfile:'suv'},
  {id:'kia-sportage', year:2022, make:'Kia', model:'Sportage', body:'SUV', img:'assets/images/vehicle-fallbacks/kia-sportage.jpg', lampProfile:'suv'},
  {id:'subaru-forester', year:2021, make:'Subaru', model:'Forester', body:'SUV', img:'assets/images/vehicle-fallbacks/subaru-forester.jpg', lampProfile:'suv'},
  {id:'jeep-grand-cherokee', year:2021, make:'Jeep', model:'Grand Cherokee', body:'SUV', img:'assets/images/vehicle-fallbacks/jeep-grand-cherokee.jpg', lampProfile:'suv'},
  {id:'bmw-3-series', year:2021, make:'BMW', model:'3 Series', body:'Sedan', img:'assets/images/vehicle-fallbacks/bmw-3-series.jpg', lampProfile:'premium-sedan'},
  {id:'mercedes-c-class', year:2021, make:'Mercedes-Benz', model:'C-Class', body:'Sedan', img:'assets/images/vehicle-fallbacks/mercedes-c-class.jpg', lampProfile:'premium-sedan'},
  {id:'audi-a4', year:2021, make:'Audi', model:'A4', body:'Sedan', img:'assets/images/vehicle-fallbacks/audi-a4.jpg', lampProfile:'premium-sedan'},
  {id:'toyota-highlander', year:2022, make:'Toyota', model:'Highlander', body:'SUV', img:'assets/images/vehicle-fallbacks/toyota-highlander.jpg', lampProfile:'suv-alt'},
  {id:'honda-accord', year:2022, make:'Honda', model:'Accord', body:'Sedan', img:'assets/images/vehicle-fallbacks/honda-accord.jpg', lampProfile:'sedan-alt'},
  {id:'ford-explorer', year:2022, make:'Ford', model:'Explorer', body:'SUV', img:'assets/images/vehicle-fallbacks/ford-explorer.jpg', lampProfile:'suv-alt'},
  {id:'chevrolet-tahoe', year:2022, make:'Chevrolet', model:'Tahoe', body:'SUV', img:'assets/images/vehicle-fallbacks/chevrolet-tahoe.jpg', lampProfile:'suv-alt'},
  {id:'kia-k5', year:2022, make:'Kia', model:'K5', body:'Sedan', img:'assets/images/vehicle-fallbacks/kia-k5.jpg', lampProfile:'premium-sedan'},
  {id:'toyota-corolla-cross', year:2022, make:'Toyota', model:'Corolla Cross', body:'SUV', img:'assets/images/vehicle-fallbacks/toyota-corolla-cross.jpg', lampProfile:'suv-alt'},
  {id:'toyota-land-cruiser', year:2022, make:'Toyota', model:'Land Cruiser', body:'SUV', img:'assets/images/vehicle-fallbacks/toyota-land-cruiser.jpg', lampProfile:'suv-alt'},
  {id:'nissan-sentra', year:2022, make:'Nissan', model:'Sentra', body:'Sedan', img:'assets/images/vehicle-fallbacks/nissan-sentra.jpg', lampProfile:'sedan'},
  {id:'honda-pilot', year:2022, make:'Honda', model:'Pilot', body:'SUV', img:'assets/images/vehicle-fallbacks/honda-pilot.jpg', lampProfile:'suv'},
  {id:'hyundai-santa-fe', year:2022, make:'Hyundai', model:'Santa Fe', body:'SUV', img:'assets/images/vehicle-fallbacks/hyundai-santa-fe.jpg', lampProfile:'suv-alt'},
  {id:'volkswagen-passat', year:2022, make:'Volkswagen', model:'Passat', body:'Sedan', img:'assets/images/vehicle-fallbacks/volkswagen-passat.jpg', lampProfile:'sedan'},
  {id:'toyota-prius-prime', year:2022, make:'Toyota', model:'Prime', body:'Sedan', img:'assets/images/vehicle-fallbacks/toyota-corolla.jpg', lampProfile:'sedan'},
  {id:'toyota-vitz-yaris', year:2021, make:'Toyota', model:'Vitz/Yaris', body:'Sedan', img:'assets/images/vehicle-fallbacks/toyota-corolla.jpg', lampProfile:'sedan'},
  {id:'toyota-noah-voxy', year:2021, make:'Toyota', model:'Noah/Voxy', body:'SUV', img:'assets/images/vehicle-fallbacks/toyota-highlander.jpg', lampProfile:'suv-alt'},
  {id:'toyota-hilux-vigo', year:2015, make:'Toyota', model:'Hilux Vigo', body:'Pickup', img:'assets/images/vehicle-fallbacks/toyota-hilux.jpg', lampProfile:'pickup'},
  {id:'isuzu-dmax', year:2022, make:'Isuzu', model:'D-MAX', body:'Pickup', img:'assets/images/vehicle-fallbacks/ford-ranger.jpg', lampProfile:'pickup'},
  {id:'suzuki-swift', year:2022, make:'Suzuki', model:'Swift', body:'Sedan', img:'assets/images/vehicle-fallbacks/honda-civic.jpg', lampProfile:'sedan'}
...
const fitmentModelMap = {"Toyota": ["Prius", "Prime", "Lexus", "Corolla", "Axio", "Fielder", "Camry", "RAV4", "Hiace", "Highlander", "Tacoma", "Vitz", "Yaris", "Noah", "Voxy", "Allion", "Premio", "Probox", "Succeed", "IST", "Scion XA", "Urban Cruiser", "Ractis", "Hilux", "Hilux Vigo", "Fortuner", "Land Cruiser", "Prado", "Rush", "Avanza", "Reiz", "Mark X", "Corolla Cross", "C-HR", "Yaris Cross"], "Lexus": ["RX", "ES", "IS", "NX", "GX", "LX"], "Honda": ["Fit", "Jazz", "Vezel", "HR-V", "CR-V", "Civic", "XR-V", "City", "Grace", "Accord", "Odyssey", "Brio", "Pilot"], "Nissan": ["Sunny", "Tiida", "X-Trail", "Navara", "Patrol", "Sentra", "Almera", "Kicks", "Rogue", "Altima"], "Suzuki": ["Swift", "Dzire", "S-Presso", "Ciaz", "Vitara", "Jimny", "Alto", "Ertiga"], "Hyundai": ["Elantra", "Tucson", "Sonata", "Santa Fe"], "Kia": ["Sportage", "Rio", "Sorento", "K5"], "Hyundai/Kia": ["Elantra", "Tucson", "Sonata", "Santa Fe", "Sportage", "Rio", "Sorento", "K5", "Starex / H1"], "Mazda": ["Mazda 2", "Mazda 3", "Mazda 6", "CX-5", "BT-50"], "Mitsubishi": ["Lancer", "Pajero", "Outlander", "Triton", "L200"], "Ford": ["Ranger", "Everest", "Focus", "Transit", "Explorer", "F-150", "Ford Ranger", "4x4 Pick up"], "Isuzu": ["D-MAX", "Dmax", "MU-X", "Isuzu D-MAX", "Isuzu Dmax", "4x4 Pick up"], "Pick-Up": ["Hilux Vigo", "Tacoma", "Isuzu D-MAX", "Isuzu Dmax", "Ford Ranger", "4x4 Pick up"], "Mercedes-Benz": ["C-Class", "E-Class", "GLC", "GLE", "Sprinter"], "BMW": ["3 Series", "5 Series", "X3", "X5", "X1"], "Tesla": ["Model 3", "Model Y", "Model S", "Model X"], "Volkswagen": ["Jetta", "Tiguan", "Passat"], "Chevrolet": ["Silverado", "Tahoe"], "Subaru": ["Forester"], "Jeep": ["Grand Cherokee"], "Audi": ["A4"], "Rolls-Royce": ["Ghost", "Wraith", "Cullinan"], "Bentley": ["Continental", "Bentayga", "Flying Spur"], "Maserati": ["Ghibli", "Levante", "Quattroporte"], "Renault": ["Clio", "Megane", "Kangoo", "Duster"], "Aston Martin": ["DB11", "Vantage", "DBX"], "Multiple Makes": ["Universal", "Mixed Order", "OE Matching"], "Other": ["Photo Matching", "OE Matching", "4x4 Pick up"]};
const allFitmentMakes = ["Toyota", "Lexus", "Honda", "Nissan", "Suzuki", "Hyundai", "Kia", "Hyundai/Kia", "Mazda", "Mitsubishi", "Ford", "Isuzu", "Pick-Up", "Mercedes-Benz", "BMW", "Tesla", "Volkswagen", "Chevrolet", "Subaru", "Jeep", "Audi", "Rolls-Royce", "Bentley", "Maserati", "Renault", "Aston Martin", "Multiple Makes", "Other"];
